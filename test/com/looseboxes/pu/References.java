...
public interface References<E> {
    ...
    public static enum itemtype{DataType,Thing,Intangible,Product,JobPosting("Job Posting"),Vehicle;
        private final String label;
    ...
    public static enum paymentmethod{MasterCard,VisaCard,Verve,BankDeposit,CashonDelivery,BookonHold}
    public static enum orderstatus{Pending,Ordered}
    public static enum paymentstatus{Pending,ProcessingPayment,PaymentReceived,PaymentDeclined,PartPaid}
    public static enum shippingstatus{Pending,PartiallyDispatched,FullyDispatched,PartiallyArrived,FullyArrived,PartiallyReceived,FullyReceived}
