...
/**
 * @author Chinomso Bassey Ikwuagwu on Oct 15, 2017 4:02:33 PM
 */
public class GetIdentifierQuoteStringForPersistenceUnit implements Function<String, String> {

    private final Function<String, EntityManagerFactory> emfProvider;
    
    public GetIdentifierQuoteStringForPersistenceUnit(            
    ...
    public String apply(String persistenceUnit) {
        ...
        final MetaDataParser<String> getIdentifierQuote = (dbmd) -> {
            try{
                return dbmd.getIdentifierQuoteString();
            }catch(SQLException e) { throw new RuntimeException(e); }
        };
        return fetchMetaData.apply(getIdentifierQuote);
    }
}
