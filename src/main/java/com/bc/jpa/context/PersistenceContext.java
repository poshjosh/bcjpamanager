...
public interface PersistenceContext extends AutoCloseable, Function<String, EntityManagerFactory> {
    ...
    EntityReference getEntityReference(String persistenceUnit);
    ...
    <E> EntityMemberAccess<E, Object> getEntityMemberAccess(String persistenceUnit, Class<E> entityClass);
}
