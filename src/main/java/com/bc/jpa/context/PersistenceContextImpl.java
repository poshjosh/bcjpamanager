...
public class PersistenceContextImpl implements PersistenceContext, Serializable {
    ...
    public PersistenceContextImpl(SQLDateTimePatterns dateTimePatterns, Class... entityClasses) { 
        this(new GetPersistenceUriForEntityClasses().apply(Arrays.asList(entityClasses)), dateTimePatterns);
    }
    ...
    public PersistenceContextImpl(
        ...
        this(new GetPersistenceUriForEntityClasses().apply(Arrays.asList(entityClasses)), 
                emfCreator, 
                dateTimePatterns);
    }
    ...
    public EntityReference getEntityReference(String persistenceUnit) {
        return this.getContext(persistenceUnit).getEntityReference();
    }
    ...
    public <E> EntityMemberAccess<E, Object> getEntityMemberAccess(String persistenceUnit, Class<E> entityClass) {
        return this.getContext(persistenceUnit).getEntityMemberAccess(entityClass);
    }
