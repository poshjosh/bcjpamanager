 ...
 * @since    2.0
 */
public interface EntityController<E, e> extends EntityMemberAccess<E, e> {
...
///////////// Methods from previous class EntityControllerBase////////////  
    ...
    void persist(E entity) throws PreexistingEntityException, Exception;
    
    int persist(Collection<E> entities); 

    int remove(Collection<e> ids);
    
    void remove(e id) throws IllegalOrphanException, NonexistentEntityException;
    
    int merge(Collection<E> entities);
    
    E merge(E entity) throws NonexistentEntityException, Exception;
