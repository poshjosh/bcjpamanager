...
public class ReferencingEntityController<K, k, E> 
    ...
    public ReferencingEntityController(
            PersistenceUnitContext persistenceUnitContext, Class referencingClass) {
    
        super(persistenceUnitContext, referencingClass);
    }
    ...
    private Object getReferenceValue(E reference, String columnName) {
        return this.getValue(reference.getClass(), 
                reference, null, columnName);
    }

    private void setReferenceValue(E reference, String columnName, Object columnValue) {
        this.setValue(reference.getClass(), 
                reference, null, columnName, columnValue);
    }
    
    @Override
    public void persist(K referencing) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            Map<String, String> refs = er.getReferences(this.getEntityClass());

            Field [] fields = this.getEntityClass().getDeclaredFields();
            
            for(String refingColumn:refs.keySet()) {
                
                E reference = (E)this.getValue(this.getEntityClass(), 
                    referencing, fields, refingColumn);
                
                Class refClass = er.getReferenceClass(this.getEntityClass(), refingColumn);
...
//                    this.setReference(referencing, reference, refClass);
    ...
    @Override
    public K merge(K refing) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for(String refingColumn:refs.keySet()) {
                ...
                if (crossrefIdNew != null) {
                    ...
                    Class refClass = er.getReferenceClass(refingClass, refingColumn);
    ...
    @Override
    public void remove(k id) throws NonexistentEntityException {
...
//                refing.getSiteurlid();
            ...
            Class [] refClasses = er.getReferenceClasses(this.getEntityClass());
            
            for(Class refClass:refClasses) {
                
                String crossRefColumn = er.getReferenceColumn(refClass, this.getEntityClass());
