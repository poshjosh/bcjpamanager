...
public class JpaContextImpl implements JpaContext, Serializable {
    ...
    public JpaContextImpl(
        ...
        this.puName = new PersistenceDOMImpl(persistenceURI).getPersistenceUnitNames().get(0);
...
//            controller = new RelatedEntityController(metaData, entityClass);
    ...
    public EntityReference getEntityReference() {
        return getPersistenceContext().getEntityReference();
    }

    @Override
    public <E> EntityUpdater<E, Object> getEntityUpdater(String persistenceUnit, Class<E> entityClass) {
        return getPersistenceContext().getEntityUpdater(persistenceUnit, entityClass);
    }
    ...
    public <E> EntityUpdater<E, Object> getEntityUpdater(Class<E> entityClass) {
        return getPersistenceContext().getContext(puName).getEntityUpdater(entityClass);
    }
            ...
            try{
                this.persistenceContext = new PersistenceContextImpl(
                        ...
                        new EntityManagerFactoryCreatorImpl(
                                new GetClassLoaderForPersistenceUri().apply(persistenceURI.toString()),
