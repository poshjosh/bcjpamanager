...
//                    this.setReferencing(reference, new ArrayList<K>(), refingClass);
                ...
                for (K referencing : refingList) {
                    ...
                    Map<String, String> refs = 
                            this.getMetaData().getReferences(refingClass);
...
XLogger.getInstance().log(Level.FINE, "Entity class: {0}, referencing classes: {1}",
...
this.printReferencingList(
        ...
        referenceFromDb, refingClass, refingListFromInput);
                    ...
                    String crossRefColumn = metaData.getReferenceColumn(this.getEntityClass(), refingClass);

XLogger.getInstance().log(Level.FINER, "Refing class: {0}, id column: {1}, cross ref column: {2}",
this.getClass(), refingClass, refingIdColumn, crossRefColumn);
...
XLogger.getInstance().log(Level.FINER, "Entity type: {0}, entity: {1}, column: {2}, value: {3}",
this.getClass(), this.getEntityClass().getName(), refingFromInput, crossRefColumn, reference);
...
XLogger.getInstance().log(Level.FINER, "Removing referencing entity: {0} form list in reference from database: {1}", 
this.getClass(), refingFromInput, referenceFromDb);
...
XLogger.getInstance().log(Level.FINER, "Reference: {0}, referencing class: {1}, referencing list:\n{2}",
this.getClass(), ref, refingClass == null ? null : refingClass.getName(), builder);
    }
