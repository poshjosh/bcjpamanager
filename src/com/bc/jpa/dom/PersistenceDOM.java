 ...
 * @since    2.0
 */
public class PersistenceDOM extends DOMImpl {

    public PersistenceDOM(File file) {
        super(file, false);
    }
    
    public PersistenceDOM(URI uri) {
        super(uri, false);
    }

    public PersistenceDOM(InputStream in) {
        super(in, false);
    }

    public PersistenceDOM(Document doc) {
        super(doc, false);
    }
