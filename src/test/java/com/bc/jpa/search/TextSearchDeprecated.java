...
import com.bc.jpa.functions.GetColumnNamesOfTypeDeprecated;
 ...
 * @deprecated Rather use {@link com.bc.jpa.search.TextSearchImpl}
 */
@Deprecated
public class TextSearchDeprecated implements TextSearch {
    
    private final JpaContext jpaContext;
    
    private final Map<String, Method[]> methodsCache;
    
    public TextSearchDeprecated(JpaContext jpaContext) {
    ...
    public <T> List<T> search(Class<T> entityType, String text, 
        ...
        try(final Select<T> dao = this.jpaContext.getDaoForSelect(entityType)) {

            final Collection<String> columnsToSearch = 
                    new GetColumnNamesOfTypeDeprecated(this.jpaContext).apply(entityType, String.class);
