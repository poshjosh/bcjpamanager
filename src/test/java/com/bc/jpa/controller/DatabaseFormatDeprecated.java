...
public class DatabaseFormatDeprecated implements DatabaseFormat {
    private transient static final Logger LOG = Logger.getLogger(DatabaseFormatDeprecated.class.getName());
...
LOG.log(Level.FINER, "Column: {0}, value: {1}, database value: {2}", 
new Object[]{ key,  value,  output});
}
...
if(LOG.isLoggable(Level.FINER)){
LOG.log(Level.FINER, "Column: {0}, value: {1}",new Object[]{ key,  value});
}
        ...
        if(reference == null) {
            ...
            reference = entityReference.getReferenceOptional(entityType, col, value).orElse(null);
        }
if(LOG.isLoggable(Level.FINER)){
LOG.log(Level.FINER, "Column: {0}, value: {1}, entity: {2}",new Object[]{ key,  value,  reference});
}
